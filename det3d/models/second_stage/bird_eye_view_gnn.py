    ...
    def forward(self, example, batch_centers, num_point):
        ...
        for batch_idx in range(batch_size):
            ...
            if num_point > 1:
                ...
                feature_map = torch.mean(torch.stack([feature_map[i*section_size: (i+1)*section_size] for i in range(num_point)]), dim=0) # mean rather than cat to have low dimension
